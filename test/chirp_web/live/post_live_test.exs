defmodule ChirpWeb.PostLiveTest do
  ...
  @create_attrs %{body: "some body", likes_count: "some likes_count", reposts_count: "some reposts_count", username: "some username"}
  @update_attrs %{body: "some updated body", likes_count: "some updated likes_count", reposts_count: "some updated reposts_count", username: "some updated username"}
